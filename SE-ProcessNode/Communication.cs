...
namespace IngameScript
{
    partial class Program
    {
        public class Communication
        {
            ...
            public bool hasNewShip
            {
                get { return broadcastListener.HasPendingMessage; }
            }
            public List<MyIGCMessage> getNewShipMessage()
            {
                List<MyIGCMessage> messages = new List<MyIGCMessage>();
                while (broadcastListener.HasPendingMessage)
                {
                    messages.Add(broadcastListener.AcceptMessage());
                }
                return messages;
            }
            /*
